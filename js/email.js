...
function handleAuthResult(authResult) {
    if (authResult && !authResult.error) {
        ...
        // sign in add signout btn, table, compose
        $('#signout_button').css('visibility', 'visible');
        $('.table-inbox').css('display', 'block');
        $('#compose-button').css('visibility', 'visible');
    } else {
        // sign out remove signout btn, table, compose
        $('#signout_button').css('visibility', 'hidden');
        $('.table-inbox').css('display', 'none');
        $('#compose-button').css('visibility', 'hidden');
...
function signOut() {
    document.location.href = "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://project-galih.et.r.appspot.com/email.html";
}
